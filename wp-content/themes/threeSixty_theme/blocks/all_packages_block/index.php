      ...
      <div class="package-box-wrapper">
        <div class="package-title-and-price">
          <div class="icon-and-package-title">
            ...
            <div class="title-and-excerpt flex-col">
              <div class="package-title d-xs-6 bold uppercase-text"><p>STARTER <strong>PACKAGE</strong></p>
              </div>
              <div class="text-md description regular gray-500">The Perfect Beginning for Your Project.</div>
            </div>
          </div>
        ...
        <div class="cta-button-wrapper">
          <a class="theme-cta-button uppercase-text" href="#" target="">
            GET STARTED              <svg aria-hidden="true" width="18" height="21" viewBox="0 0 18 21" fill="none">
