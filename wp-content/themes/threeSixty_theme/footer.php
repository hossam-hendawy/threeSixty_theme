...
$first_column = (is_array($first_column) && isset($first_column['column_title'])) ? $first_column['column_title'] : '';
$second_column = (is_array($second_column) && isset($second_column['column_title'])) ? $second_column['column_title'] : '';
$third_column = (is_array($third_column) && isset($third_column['column_title'])) ? $third_column['column_title'] : '';
$fourth_column = (is_array($fourth_column) && isset($fourth_column['column_title'])) ? $fourth_column['column_title'] : '';
?>
<!--region footer-->
<footer>
  <div class="container">
