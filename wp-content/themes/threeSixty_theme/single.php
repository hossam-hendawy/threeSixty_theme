...
<?php if (have_posts()): the_post(); ?>
  <div class="single-post-wrapper">
          ...
          <div class="author-social-links">
            <div class="about-author">
              ...
              <div class="author-info">
                <div
                  class="text-lg capital-text semi-bold gray-900 author-name"><?= $author_name ?></div>
                <div
                  class="text-md capital-text regular gray-600 author-jop"> <?= $user_jop_title ?></div>
              </div>
            </div>
            <div class="social-links">
              <div class="social-link text-sm semi-bold copy-link"
                   aria-label="Copy link to clipboard" tabindex="0">
                <title>Copy Link Icon</title>
                <div class="copied-text white-color">
                  <?= $text_label = t('Copied', 'text', 'Copied Label'); ?>
                </div>
                <svg width="20" height="20" viewBox="0 0 20 20" fill="none"
                  ...
                  <g clip-path="url(#copy-link)">
                    <path
                      ...
                      stroke="#364152" stroke-width="1.66667"
                ...
                <?= $text_label = t('Copy link', 'text', 'Copy link Label'); ?>
              </div>
              <a class="social-link"
                ...
                <svg width="20" height="20" viewBox="0 0 20 20" fill="none"
                  ...
                  <g clip-path="url(#clip0_273_4048)">
                    <path fill-rule="evenodd" clip-rule="evenodd"
                          d="M13.2879 19.1668L8.66337 12.5752L2.87405 19.1668H0.424805L7.57674 11.0261L0.424805 0.833496H6.71309L11.0717 7.04601L16.5327 0.833496H18.982L12.1619 8.59723L19.5762 19.1668H13.2879ZM16.0154 17.3085H14.3665L3.93176 2.69183H5.58092L9.7601 8.54446L10.4828 9.56005L16.0154 17.3085Z"
                          fill="#9AA3B2"/>
                  </g>
                  <defs>
    ...
    <section id="recent_posts" data-section-class="recent_posts"
             class="threeSixty_theme-block recent_posts">
      <div class="container">
        <?php
        ...
        <?php if ($query->have_posts()): ?>
          ...
          <div class="swiper-navigations">
            <div class="swiper-button-prev swiper-navigation arrow"
                 role="button" tabindex="0" aria-label="Previous Slide">
              <svg width="56" height="56" viewBox="0 0 56 56" fill="none"
                   aria-hidden="true">
                <path class="border" d="M0.5 0.5H55.5V55.5H0.5V0.5Z"
                      stroke="Red"/>
                <path class="arrow" d="M35 28H21M21 28L28 35M21 28L28 21"
                      stroke="#475467" stroke-width="2" stroke-linecap="round"
                      stroke-linejoin="round"/>
              </svg>
            </div>
            <div class="swiper-button-next swiper-navigation arrow"
                 role="button" tabindex="0" aria-label="Next Slide">
              <svg width="56" height="56" viewBox="0 0 56 56" fill="none"
                   aria-hidden="true">
                <path class="border" d="M0.5 0.5H55.5V55.5H0.5V0.5Z"
                      stroke="#98A2B3"/>
                <path class="arrow" d="M21 28H35M35 28L28 21M35 28L28 35"
                      stroke="#475467" stroke-width="2" stroke-linecap="round"
                      stroke-linejoin="round"/>
              </svg>
            </div>
