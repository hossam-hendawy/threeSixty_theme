...
class jh_acf_field_table extends acf_field {
  ...
  */
  ...
  function __construct() {
    ...
    */
    $this->settings = array(
      'version' => '1.3.17',
      'dir_url' => get_template_directory_uri() . '/custom-acf-fields/acf-table-field/',
    );
    ...
    */
    ...
    $this->l10n = array(//'error'	=> __('Error! Please enter a higher value.', 'acf-table'),
    );
  ...
  */
  ...
  function input_admin_enqueue_scripts() {
    ...
    // register & include JS
    wp_enqueue_script( 'acf-input-table', $this->settings['dir_url'] . 'js/input-v5.js', array(
      'jquery',
      'acf-input'
