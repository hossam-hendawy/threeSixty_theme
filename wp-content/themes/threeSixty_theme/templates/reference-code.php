...
$working_info = get_field('working_info', 'options');
$contact_email = get_field('contact_email', 'options');
?>
<?php if ($contact_number) : ?>
  <a href="tel:<?= $contact_number ?>" class="en-h6 white-color contact-number">
    <svg width="14" height="15" viewBox="0 0 14 15" fill="none" aria-hidden="true">
      <path d="M4.08794 5.28332C4.60994 6.37054 5.32153 7.38952 6.22272 8.2907C7.1239 9.19189 8.14288 9.90348 9.23009 10.4255C9.32361 10.4704 9.37037 10.4928 9.42954 10.5101C9.6398 10.5714 9.898 10.5273 10.0761 10.3998C10.1262 10.364 10.169 10.3211 10.2548 10.2354C10.517 9.97315 10.6481 9.84204 10.7799 9.75633C11.2771 9.43308 11.918 9.43308 12.4152 9.75633C12.547 9.84204 12.6781 9.97315 12.9403 10.2354L13.0865 10.3815C13.4851 10.7801 13.6844 10.9794 13.7926 11.1934C14.0079 11.6191 14.0079 12.1218 13.7926 12.5475C13.6844 12.7615 13.4851 12.9608 13.0865 13.3594L12.9683 13.4776C12.571 13.8748 12.3724 14.0734 12.1024 14.2251C11.8028 14.3934 11.3374 14.5144 10.9937 14.5134C10.684 14.5125 10.4724 14.4524 10.049 14.3323C7.77399 13.6865 5.62721 12.4682 3.83623 10.6772C2.04524 8.8862 0.826889 6.73943 0.181161 4.46439C0.0610058 4.04105 0.000927553 3.82938 6.43396e-06 3.51967C-0.00101634 3.17601 0.120005 2.71064 0.288321 2.41101C0.440006 2.14099 0.638615 1.94238 1.03583 1.54516L1.15406 1.42693C1.55264 1.02835 1.75193 0.829062 1.96597 0.720803C2.39164 0.505501 2.89434 0.505501 3.32001 0.720803C3.53404 0.829061 3.73333 1.02835 4.13192 1.42693L4.27807 1.57309C4.54027 1.83529 4.67137 1.96639 4.75709 2.09823C5.08034 2.59539 5.08034 3.23633 4.75709 3.7335C4.67137 3.86533 4.54027 3.99643 4.27807 4.25864C4.19233 4.34437 4.14947 4.38724 4.11359 4.43735C3.98608 4.61542 3.94205 4.87362 4.00334 5.08388C4.02059 5.14305 4.04304 5.18981 4.08794 5.28332Z" fill="white"/>
    </svg>
    <?= $contact_number ?></a>
<?php endif; ?>
<?php if ($contact_email) : ?>
  <a href="mailto:<?= $contact_email ?>"
     class="body white-color"><?= $contact_email ?> </a>
<?php endif; ?>
<?php if ($working_info) : ?>
  <div class="body white-color"><?= $working_info ?></div>
<?php endif; ?>
...
<div class="cards-wrapper project-card">
    ...
    <div class="right-content">
        <a href = "" class="post-title body navy-color bold">Full Automated Access at Heathrow</a>
  ...
  <div class="row">
    <div class="col-6 col-md-3">
      <div class="product-card">
        ...
        <div class="excerpt captions center-content">Seamlessly designed for hands-free entry</div>
    ...
    <div class="col-6 col-md-3">
      <div class="testimonials-card">
        ...
        <div class="title body-2 navy-color medium">
          “Entec provide an excellent service over the phone and on site, every job gets treated with the same high
          standard
          and the installation engineers are very helpful, reliable and knowledgeable.”
        </div>
        <div class="card-info">
          ...
          <div class="jop-title captions regular navy-color  navy-tint-color">Facility Manager, John Lewis</div>
        </div>
      </div>
    </div>
    <!--     video card-->
    ...
    <div class="col-6 col-md-3">
      <div class="testimonials-card has-image">
        ...
        <div class="card-info">
          ...
          <div class="jop-title captions regular navy-color  navy-tint-color">Commercial Director Entec Systems</div>
        </div>
      </div>
    </div>
  </div>
  ...
  <div class="row">
    <div class="col-6 col-md-4">
      <div class="project-card">
        ...
        <a href="#" target="_self" class="post-title body navy-color bold">Central London Vet</a>
    ...
    <div class="col-6 col-md-4">
      <div class="project-card has-border">
        ...
        <div class="project-info">
          <a href="#" target="_self" class="post-title body navy-color medium">Central London Vet</a>
          <div class="body-2 regular ">Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor
