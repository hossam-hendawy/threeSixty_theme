    ...
    public function referal_menu_item( \WP_Admin_Bar $wp_admin_bar ) {
        if ( ! get_transient( self::HIDE_HOSTINGER_ADMIN_BAR_REFER ) && in_array( 'administrator', wp_get_current_user()->roles, true ) ) {
            ...
            $wp_admin_bar->add_menu( [
                ...
                'parent' => null,
                'group'  => null,
                'title'  => '<a href="https://hpanel.hostinger.com/referrals" target="_blank">'
                            . $hostinger_icon
                            . esc_html__( 'Refer & earn up to ', 'hostinger-easy-onboarding' )
                            . '<span class="hostinger-up-to">20%</span>'
                            . '</a>'
                            . '<span class="hostinger-close-button">'
                            . $close_icon
                            . '</span>',
                'href'   => false,
            ] );
