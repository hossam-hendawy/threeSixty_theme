...
<div class="wp-filter hide-if-no-js">
	...
	<form class="search-form" method="get" style="margin-top: 0.8em;">
...
<div class="theme-overlay hidden" tabindex="0" role="dialog" aria-label="Theme Details">
	...
	<div class="theme-wrap wp-clearfix" role="document">
		...
		<div class="theme-actions">
			<div>
				<?php if ( current_user_can( 'mailster_change_template' ) ) : ?>
				<a href="" class="button default"><?php esc_html_e( 'Use as default', 'mailster' ); ?></a>
				<?php endif; ?>
				<?php if ( current_user_can( 'mailster_update_templates' ) ) : ?>
			...
			<?php if ( current_user_can( 'mailster_delete_templates' ) ) : ?>
